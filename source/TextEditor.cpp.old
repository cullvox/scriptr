...
void TextEditor::SetFonts(ImFont* normalFont, ImFont* boldFont, ImFont* italicFont, ImFont* italicBoldFont)
{
	mNormalFont = normalFont;
	mBoldFont = boldFont;
	mItalicFont = italicFont;
	mItalicBoldFont = italicBoldFont;
}
...
void TextEditor::BuildTextBlocks() {
	if (mLines.empty())
		return;
